 ...
 * 搜索GridView 点击跳转详情页 行布局 适配器
 */
public class SearchGvDetailsAdapter extends BaseAdapter {

    private List<SearchGvDetailsBean.ItemsBean> data;
    private Context context;

    public SearchGvDetailsAdapter(Context context) {
        this.context = context;
    }

    public void setData(List<SearchGvDetailsBean.ItemsBean> data) {
        this.data = data;
